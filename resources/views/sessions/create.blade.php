...
@section('main')
            ...
            <form class="needs-validation" novalidate action="{{ route('session.store',$campaign) }}" method="POST">
                @csrf
                ...
                <div class="row">
                    <div class="col-12 col-lg-4 mb-3">
                        ...
                        <input type="text" class="form-control {{ $errors->first('title')?'is-invalid':'' }}" id="inputTitle" name="title" placeholder="" value="{{ old('title') }}">
                ...
                <div class="row">
                    <div class="col-12 col-lg-4 mb-3">
                        ...
                        <input type="text" class="form-control {{ $errors->first('vaccinator')?'is-invalid':'' }}" id="inputParticipant" name="vaccinator" placeholder="" value="{{ old('vaccinator') }}">
                        <div class="invalid-feedback">
                ...
                <div class="row">
                    <div class="col-12 col-lg-4 mb-3">
                        ...
                        <select class="form-control {{ $errors->first('place_id')?'is-invalid':'' }}" id="selectPlace" name="place_id">
                            ...
                            <option value="{{ $place->id }}" {{ old('place_id')==$place->id?'selected':'' }}>{{ $place->name }} / {{ $place->area->name }}</option>
                            @endforeach
                ...
                <div class="row">
                    <div class="col-12 mb-3">
                        ...
                        <textarea class="form-control {{ $errors->first('description')?'is-invalid':'' }}" id="textareaDescription" name="description" placeholder="" rows="5">{{ old('description') }}</textarea>
                        <div class="invalid-feedback">
